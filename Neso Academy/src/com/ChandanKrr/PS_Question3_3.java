...
class PS_Question3_3 {
    private double db1;
    private long lg;

    public PS_Question3_3() {
        db1 = 108.0d;
        lg = 249;
    }

    public PS_Question3_3(double d, long l) {
        db1 = d;
        lg = 1;
    }

    public boolean isZero() {
        if (db1 == 0.0) return true;
        else return false;
    }
    ...
    public static void main(String args[]) {
        PS_Question3_3 mynum = new PS_Question3_3();
        double d = 199;
